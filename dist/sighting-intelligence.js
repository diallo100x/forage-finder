...
(function (global) {
  ...
  const regionAliases={
    'mid-atlantic':['virginia','maryland','delaware','pennsylvania','new jersey','washington dc','west virginia'],
    'virginia piedmont':['richmond','charlottesville','fredericksburg','piedmont'],
    'central virginia':['richmond','henrico','chesterfield','hanover','goochland']
  };
