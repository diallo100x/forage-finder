...
(function (global) {
  ...
  function privacySafe(signal){if(signal.geoprivacy==='private')return{...signal,lat:null,lng:null,locationPrecision:'hidden'};if(signal.geoprivacy==='obscured')return{...signal,locationPrecision:'obscured'};return signal;}
  function normalize(raw){const safe=privacySafe(raw);return{...safe,score:score(safe),tags:[...(safe.tags||[])]};}
